...
/*
  ...
  |_   _|___ ___|  |  |     |   | |     |
    ...
    Fork by Agamenon/Wizball: https://github.com/Wizball74/Tonuino
*/

// uncomment for five button support
//#define FIVEBUTTONS
// uncomment for rotary encoder support (Drehregler Lautstärke)
#define ROTARY_ENCODER
// uncomment for long press play/pause = shutdown
#define HOLD_PAUSE_FOR_SHUTDOWN
// uncomment if power led available
#define POWER_ON_LED
// uncomment for startup sound (Ordner "mp3": Dateien 0264_StartUp.mp3 und 0265_ShutDown.mp3 notwenig... siehe GIT-Hub)
...
uint8_t voiceMenu(int numberOfOptions, int startMessage, int messageOffset,
                  ...
                  int defaultValue = 0, bool exitWithLongPress = false);
bool isPlaying();
...
public:
  ...
  virtual bool handleVolume() { return false; }
  virtual bool handleShutDown() { return false; }
...
public:
  ...
  virtual bool handleVolume() {
    Serial.println(F("== Locked::handleVolume() -> LOCKED!"));
    return true;
  }
...
public:
  ...
  virtual bool handleShutDown() {
    Serial.println(F("== ToddlerMode::handleShutDown() -> LOCKED!"));
    return true;
  }
  ToddlerMode(void) {
...
int16_t RotEncPos = 0;
ClickEncoder encoder(ROTARY_ENCODER_PIN_A, ROTARY_ENCODER_PIN_B,
...
void setstandbyTimer() {
  ...
  if (mySettings.standbyTimer != 0)
    ...
    sleepAtMillis = 0;
  Serial.println("sleepAtMillis: " + sleepAtMillis);
}
...
void playFolder() {
  ...
  if (myFolder->mode == 8) {
    Serial.println(F("Spezialmodus Von-Bis: Album: alle Dateien zwischen "
  ...
  if (myFolder->mode == 9) {
    Serial.println(F("Spezialmodus Von-Bis: Party -> Ordner in zufälliger "
